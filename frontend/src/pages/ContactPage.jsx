...
import appContactImg from "../assets/images/app_contact.svg";
    ...
    <main>
      ...
      <section className="content-grid">
        <div className="grid-container">
          <img className="grid-container__image" src={appContactImg}></img>
          <div className="contact-us__content card-container">
            <div>
              ...
              <p><b>Email:</b> support@memobanking.com</p>
              <p><b>Phone:</b> +61 1234 1234</p>
            </div>

            <div>
              <p>Follow us on social media for updates and more</p>
              <p><b>Twitter:</b>@Memobanking</p>
              <p><b>Facebook: </b>Memobanking</p>
              <p><b>Instagram:</b> @MemobankingApp</p>
            </div>
          </div>
        </div>
      </section>

        ...
        <section className="homepage content-grid">
                ...
                <div className="hp-mission card-container">
                    <div className="hp-mission__content">
                        ...
                        <p>
                        By providing a structured way to track and understand your
                        emotions, Memobanking aims to be a proactive platform in
                        addressing these issues. Our app offers valuable tools to navigate
                        and understand your emotional landscape, whether for personal
                        growth or mental health management.
                        </p>
                    </div>
                ...
                <div className="hp-cta card-container">
                    <div>
                        ...
                        <p>
                        Join us on a journey to self-awareness and emotional regulation.
                        Start logging your emotions today and take the first step towards
                        a healthier, happier you.
                        </p>
                    </div>

                    <div className="hp-cta__content">
                        <Link to="/signup" className="hp-cta__btn">
